...
class ReimbursementTypeController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('super-admin.reimbursement-types.index', compact('types', 'search', 'totalTypes'));
    }

    public function show(ReimbursementType $reimbursementType)
    {
        return view('super-admin.reimbursement-types.show', compact('reimbursementType'));
    }

    public function create()
    {
        return view('super-admin.reimbursement-types.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('super-admin.reimbursement-types.index')
            ->with('success', 'Tipe reimbursement berhasil ditambahkan.');
    }

    public function edit(ReimbursementType $reimbursementType)
    {
        return view('super-admin.reimbursement-types.edit', compact('reimbursementType'));
    }
