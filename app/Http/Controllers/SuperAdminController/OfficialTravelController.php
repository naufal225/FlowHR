...
class OfficialTravelController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('super-admin.official-travel.show', compact('officialTravel'));
    }

    public function create()
    {
        return view('super-admin.official-travel.create');
    }
    ...
    public function edit(OfficialTravel $officialTravel)
    {
        ...
        if ($officialTravel->status_1 !== 'pending' || $officialTravel->status_2 !== 'pending') {
            return redirect()->route('super-admin.official-travels.edit', $officialTravel->id)
