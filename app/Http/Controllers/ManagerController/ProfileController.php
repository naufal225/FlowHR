...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('manager.profile.index')->with('success', 'Profile updated successfully!');
    }
    ...
    public function updatePassword(Request $request)
    {
        ...
        return redirect()->route('manager.profile.index')->with('success', 'Password updated successfully!');
    }
}
