...
class AttendancePolicyData
{
    public function __construct(
        ...
        public readonly float $officeLatitude,
        public readonly float $officeLongitude,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            officeLatitude: (float) $data['office_latitude'],
            officeLongitude: (float) $data['office_longitude'],
    ...
    public function toArray(): array
    {
        return [
            ...
            'office_latitude' => $this->officeLatitude,
            'office_longitude' => $this->officeLongitude,
