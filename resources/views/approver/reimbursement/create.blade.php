...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
        ...
        <form action="{{ route('approver.reimbursements.store') }}" method="POST" enctype="multipart/form-data"
            class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <!-- Input tampilan -->
                    <input type="text" id="total_display" class="form-input" value="{{ old('total') }}"
            ...
            <div>
                ...
                attachment --}}
                <p class="mt-1 text-xs text-neutral-500">Accepted formats: JPG, PNG, PDF (Max 2MB). Please attach
                    receipts or invoices.</p>
            </div>
