...
@section('title', 'Request Tidak Valid')

@section('content')
    <div class="mb-4 text-5xl text-red-500">422</div>
    <h1 class="mb-2 text-2xl font-bold text-gray-900">Request Tidak Bisa Diproses</h1>
    <p class="mb-6 text-gray-600">
        Tautan ini sudah tidak bisa digunakan.
    </p>
