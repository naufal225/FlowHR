@php $user = Auth::user(); $permissions = $permissions ?? $user->permissions()->toArray(); @endphp
    ...
    <table class="w-full text-sm">
        ...
        <tbody class="divide-y divide-gray-50">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-5 py-3 text-xs text-gray-600">{{ $item->type?->name ?? '–' }}</td>
                <td class="px-5 py-3 text-xs text-gray-600">{{ \Carbon\Carbon::parse($item->date)->format('d M Y') }}</td>
                <td class="px-5 py-3">
                    @php
                ...
                <td class="px-5 py-3 text-right">
                    <a href="{{ route('reimbursements.show', $item) }}"
            ...
            <tr>
                <td colspan="10" class="px-5 py-12 text-center">
                    ...
                    <p class="text-sm text-gray-400">Tidak ada data reimbursement.</p>
                </td>
            </tr>
            @endforelse
        </tbody>
