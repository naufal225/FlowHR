...
<body>
    ...
    <div style="
        ...
        <div style="
                    ...
                    color: #444;
                ">
            Request #LY{{ $leave->id }} | {{ \Carbon\Carbon::parse($leave->created_at)->format('F d, Y \a\t H:i') }}
            <br>
    ...
    <div class="section">
        <div class="sub-title">Leave Request #LY{{ $leave->id }} | {{
            \Carbon\Carbon::parse($leave->created_at)->format('F d, Y \a\t H:i') }}</div>
        ...
        <div><span class="label">Divisi:</span> <span class="value">{{ $leave->employee->division->name ?? 'N/A'
                }}</span></div>
    </div>
