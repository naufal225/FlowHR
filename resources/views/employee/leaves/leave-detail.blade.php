                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-start p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                    ...
                                    <span class="max-w-full overflow-y-auto break-all whitespace-pre-line text-neutral-900 max-h-40">{{ $leave->note_1 ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-y-6">
                <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        @if ($leave->status_1 === 'approved')
                            <button onclick="window.location.href='{{ route('employee.leaves.exportPdf', $leave->id) }}'" class="flex items-center justify-center w-full px-4 py-2 font-semibold text-white transition-colors duration-200 rounded-lg bg-secondary-600 hover:bg-secondary-700">
