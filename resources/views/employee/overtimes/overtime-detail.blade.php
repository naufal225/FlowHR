        ...
        <div class="space-y-6">
            ...
            <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
                ...
                <div class="p-6 space-y-3">
                    ...
                    <a href="{{ route('employee.overtimes.edit', $overtime->id) }}"
                    ...
                    <form action="{{ route('employee.overtimes.destroy', $overtime->id) }}" method="POST"
                    ...
                    <button onclick="window.location.href='{{ route('employee.overtimes.exportPdf', $overtime->id) }}'"
