        ...
        <div class="bg-white rounded-xl shadow-soft border border-neutral-200">
            ...
            <form action="{{ route('employee.official-travels.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="flex justify-end space-x-4 pt-6 border-t border-neutral-200">
                    <a href="{{ route('employee.official-travels.index') }}" class="px-6 py-2 text-sm font-medium text-neutral-700 bg-neutral-100 hover:bg-neutral-200 rounded-lg transition-colors duration-200">
