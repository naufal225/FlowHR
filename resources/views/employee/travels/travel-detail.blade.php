                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                    ...
                                    <span class="font-medium truncate text-neutral-900">{{ $officialTravel->customer ?? 'N/A' }}</span>
                                </div>
                            </div>
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                    ...
                                    <span class="font-medium truncate text-neutral-900">{{ $officialTravel->date_start->format('l, M d, Y') }}</span>
                                </div>
                            </div>
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                    <i class="mr-3 fas fa-calendar-alt text-secondary-600"></i>
                                    <span class="font-medium truncate text-neutral-900">{{ $officialTravel->date_end->format('l, M d, Y') }}</span>
                                </div>
                            </div>
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                    ...
                                    <span class="font-medium text-neutral-900">{{ $totalDays }} day{{ $totalDays > 1 ? 's' : '' }}</span>
                                </div>
                            </div>
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                    ...
                                    <span class="font-medium truncate text-neutral-900">{{ 'Rp ' . number_format($officialTravel->total ?? 0, 0, ',', '.') }}</span>
                                </div>
                            </div>
                            <div class="space-y-2">
                ...
                <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
                    ...
                    <div class="p-6 space-y-3">
                        @if(Auth::id() === $officialTravel->employee_id && $officialTravel->status_1 === 'pending')
                            <a href="{{ route('employee.official-travels.edit', $officialTravel->id) }}" class="flex items-center justify-center w-full px-4 py-2 font-semibold text-white transition-colors duration-200 rounded-lg bg-primary-600 hover:bg-primary-700">
                        ...
                        @endif
                        <a href="{{ route('employee.official-travels.index') }}" class="flex items-center justify-center w-full px-4 py-2 font-semibold text-white transition-colors duration-200 rounded-lg bg-neutral-600 hover:bg-neutral-700">
                            <i class="mr-2 fas fa-arrow-left"></i>
                            Back to List
                        </a>

                        @if ($officialTravel->status_1 === 'approved' && $officialTravel->status_2 === 'approved')
                            <button onclick="window.location.href='{{ route('employee.official-travels.exportPdf', $officialTravel->id) }}'" class="flex items-center justify-center w-full px-4 py-2 font-semibold text-white transition-colors duration-200 rounded-lg bg-secondary-600 hover:bg-secondary-700">
