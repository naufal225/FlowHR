...
<div class="space-y-6">
    ...
    <div class="p-6 bg-white border rounded-xl shadow-soft border-neutral-200">
        <form method="GET" action="{{ route('employee.official-travels.index') }}" class="space-y-4">
            ...
            <div
                ...
                <!-- Reset Button -->
                <button onclick="window.location.href = '{{ route('employee.official-travels.index') }}'" type="button"
                            ...
                            <tr>
                                <td colspan="10" class="px-6 py-12 text-center">
                                    <div class="text-neutral-400">
                                        ...
                                        <a href="{{ route('employee.official-travels.create') }}" class="inline-flex items-center px-4 py-2 mt-4 text-white transition-colors duration-200 rounded-lg bg-primary-600 hover:bg-primary-700">
                                            <i class="mr-2 fas fa-plus"></i>
                                            New Travel Request
                                        </a>
                                    </div>
