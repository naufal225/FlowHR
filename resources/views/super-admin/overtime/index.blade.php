...
<main class="relative z-10 flex-1 p-0 space-y-6 overflow-x-hidden overflow-y-auto bg-gray-50">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <div class="flex flex-col items-center gap-5 mt-4 sm:mt-0 sm:flex-row">
                <div class="mt-4 sm:mt-0">
                    <button onclick="window.location.href='{{ route('super-admin.overtimes.create') }}'" class="btn-primary">
                ...
                <button id="exportAllOvertimesPdf"
                    ...
                    <span id="exportOvertimesPdfButtonText">Export PDF (All)</span>
                    <svg id="exportOvertimesPdfSpinner" class="hidden w-4 h-4 ml-2 -mr-1 text-white animate-spin" fill="none" viewBox="0 0 24 24">
    ...
    <div class="p-6 bg-white border rounded-xl shadow-soft border-neutral-200">
        <form id="filterForm" method="GET" action="{{ route('super-admin.overtimes.index') }}"
            ...
            <div class="flex items-end">
                ...
                <a href="{{ route('super-admin.overtimes.index') }}" class="btn-secondary">
                        ...
                        <tr>
                            <td colspan="10" class="px-6 py-12 text-center">
                                <div class="text-neutral-400">
                                    ...
                                    <a href="{{ route('super-admin.overtimes.create') }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const exportPdfButtonText = document.getElementById('exportOvertimesPdfButtonText');
    const exportPdfSpinner = document.getElementById('exportOvertimesPdfSpinner');
    ...
    if (exportPdfButton) {
        exportPdfButton.addEventListener('click', async function() {
            ...
            try {
                ...
                const exportPdfUrl = `{{ route('super-admin.overtimes.export.pdf.all') }}?${params.toString()}`;
    ...
    exportButton.addEventListener('click', async function() {
        ...
        try {
            ...
            const exportUrl = `{{ route('super-admin.overtimes.export') }}?${params.toString()}`;
