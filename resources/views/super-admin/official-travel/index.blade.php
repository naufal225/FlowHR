...
<main class="relative z-10 flex-1 p-0 space-y-6 overflow-x-hidden overflow-y-auto bg-gray-50">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <div class="flex flex-col items-center gap-3 mt-4 sm:mt-0 sm:flex-row">
                <div class="mt-4 sm:mt-0">
                    <button onclick="window.location.href='{{ route('super-admin.official-travels.create') }}'"
                        class="btn-primary">
                        <i class="mr-2 fas fa-plus"></i>
                        New Official Travel Request
                    </button>
                </div>
                <button id="exportAllOfficialTravelsPdf"
                    ...
                    <span id="exportPdfButtonText">Export PDF (All)</span>
                    <svg id="exportPdfSpinner" class="hidden w-4 h-4 ml-2 -mr-1 text-white animate-spin" fill="none" viewBox="0 0 24 24">
    ...
    <div class="p-6 bg-white border rounded-xl shadow-soft border-neutral-200">
        <form id="filterForm" method="GET" action="{{ route('super-admin.official-travels.index') }}"
            ...
            <div class="flex items-end">
                ...
                <a href="{{ route('super-admin.official-travels.index') }}" class="btn-secondary">
                    ...
                    <tr>
                        <td colspan="10" class="px-6 py-12 text-center">
                            <div class="text-neutral-400">
                                ...
                                <a href="{{ route('super-admin.official-travels.create') }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (exportPdfButton) {
        exportPdfButton.addEventListener('click', async function() {
            ...
            try {
                ...
                const exportPdfUrl = `{{ route('super-admin.official-travels.export.pdf.all') }}?${params.toString()}`;
    ...
    exportButton.addEventListener('click', async function() {
        ...
        try {
            ...
            const exportUrl = `{{ route('super-admin.official-travels.export') }}?${params.toString()}`;
