...
<div class="max-w-3xl mx-auto">
    ...
    <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
        ...
        <form action="{{ route('super-admin.official-travels.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div>
                    ...
                    <p class="mt-1 text-xs text-neutral-500">When does your travel start?</p>
                </div>
                ...
                <div>
                    ...
                    <input type="date" id="date_end" name="date_end" class="form-input" value="{{ old('date_end') }}"
                        required min="{{ date('Y-m-d') }}" onchange="calculateDays()">
                    <p class="mt-1 text-xs text-neutral-500">When does your travel end?</p>
                </div>
            </div>
