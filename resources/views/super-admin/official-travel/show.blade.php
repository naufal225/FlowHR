                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                ...
                                <span class="font-medium text-neutral-900">{{ $officialTravel->approver1->name ?? 'N/A'
                                    }}</span>
                            </div>
                        </div>
                        <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                ...
                                <span class="font-medium text-neutral-900">{{ $officialTravel->total }} day{{
                                    $officialTravel->total > 1 ? 's' : '' }}</span>
                            </div>
                        </div>
                        <div class="space-y-2">
            ...
            <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
                ...
                <div class="p-6 space-y-3">
                    ...
                    <form id="delete-form-{{ $officialTravel->id }}"
                        action="{{ route('super-admin.official-travels.destroy', $officialTravel->id) }}" method="POST"
                        style="display: none;">
                        @csrf
                        @method('DELETE')
                    </form>
                    ...
                    <button
                        onclick="window.location.href='{{ route('super-admin.official-travels.exportPdf', $officialTravel->id) }}'"
...
function executeDelete() {
    console.log('tes');
    console.log(officialTravelIdToDelete)
    ...
    const formId = `delete-form-${officialTravelIdToDelete}`;
