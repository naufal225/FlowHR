...
<main class="relative z-10 flex-1 p-0 overflow-x-hidden overflow-y-auto bg-gray-50">
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-col gap-3 mt-4 sm:mt-0 sm:flex-row">
                ...
                <a id="addDivisionBtn" href="{{ route('super-admin.divisions.create') }}"
    ...
    <div class="mb-6">
        <div class="p-6 bg-white border border-gray-100 shadow-sm rounded-xl">
            <div class="">
                <form class="flex flex-col gap-4 sm:flex-row" action="{{ route("super-admin.divisions.index") }}"
                    method="GET">
                    <div class="flex-1">
                        <div class="relative">
                            ...
                            <td class="px-6 py-4 font-medium text-md whitespace-nowrap">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form id="delete-form-{{ $division->id }}"
                                        action="{{ route('super-admin.divisions.destroy', $division->id) }}" method="POST"
                                        style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="text-neutral-400">
                                    ...
                                    <a href="{{ route('super-admin.divisions.create') }}"
...
@push('scripts')
@vite("resources/js/super-admin/division/script.js")
@endpush
