...
<main class="relative z-10 flex-1 p-0 space-y-6 overflow-x-hidden overflow-y-auto bg-gray-50">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <a href="{{ route('super-admin.holidays.create') }}" class="btn-primary">
    ...
    <div class="p-6 bg-white border rounded-xl shadow-soft border-neutral-200">
        <form id="filterForm" method="GET" action="{{ route('super-admin.holidays.index') }}" class="space-y-4">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                ...
                <div class="flex items-end">
                    ...
                    <a href="{{ route('super-admin.holidays.index') }}" class="flex justify-center items-center px-4 py-2.5 bg-gray-100 text-gray-700 text-sm font-medium rounded-xl shadow-sm
                    ...
                    <tr class="transition-colors duration-200 hover:bg-neutral-50">
                        ...
                        <td class="px-6 py-4 text-md font-medium whitespace-nowrap">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('super-admin.holidays.show', $holiday->id) }}"
                                    class="text-primary-600 hover:text-primary-900" title="View Details">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('super-admin.holidays.edit', $holiday->id) }}"
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-12 text-center">
                            <div class="text-neutral-400">
                                ...
                                <a href="{{ route('super-admin.holidays.create') }}"
    ...
    <form id="delete-form-{{ $holiday->id }}" action="{{ route('super-admin.holidays.destroy', $holiday->id) }}" method="POST"
        style="display: none;">
        @csrf
        @method('DELETE')
    </form>
