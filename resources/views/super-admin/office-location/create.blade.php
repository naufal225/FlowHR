    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">Create a new office profile for attendance and user assignment</p>
            </div>
    ...
    <div class="max-w-3xl mx-auto">
        <div class="overflow-hidden bg-white border border-gray-100 shadow-sm rounded-xl">
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                ...
                <p class="mt-1 text-sm text-gray-600">Fill all required office setup fields</p>
            </div>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('super-admin.office-locations.store') }}" method="POST" class="space-y-6" id="officeForm">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea id="address" name="address" rows="3"
                            ...
                            placeholder="Full office address">{{ old('address') }}</textarea>
                        @error('address')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input type="number" id="radius_meter" name="radius_meter" value="{{ old('radius_meter', 100) }}"
