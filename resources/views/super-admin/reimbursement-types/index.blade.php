...
<main class="relative z-10 flex-1 p-0 overflow-x-hidden overflow-y-auto bg-gray-50">
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-col gap-3 mt-4 sm:mt-0 sm:flex-row">
                <a href="{{ route('super-admin.reimbursement-types.create') }}"
    ...
    <div class="mb-6">
        <div class="p-6 bg-white border border-gray-100 shadow-sm rounded-xl">
            <div class="">
                <form class="flex flex-col gap-4 sm:flex-row" action="{{ route('super-admin.reimbursement-types.index') }}"
                    method="GET">
                    <div class="flex-1">
                        <div class="relative">
                        ...
                        <tr class="transition-colors duration-200 hover:bg-neutral-50">
                            ...
                            <td class="px-6 py-4 font-medium text-md whitespace-nowrap">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('super-admin.reimbursement-types.edit', $type->id) }}"
                                    ...
                                    <form id="delete-form-{{ $type->id }}"
                                        action="{{ route('super-admin.reimbursement-types.destroy', $type->id) }}"
