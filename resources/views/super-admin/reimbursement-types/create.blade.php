...
@section('header', 'Add Reimbursement Type')
@section('subtitle', 'Tambahkan jenis baru untuk pengajuan reimbursement')
@section('content')
...
<main class="relative z-10 flex-1 p-6 overflow-x-hidden overflow-y-auto bg-gray-50">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Add New Reimbursement Type</h1>
                <p class="mt-2 text-sm text-gray-600">Buat jenis reimbursement baru untuk sistem</p>
            </div>
            <!-- Back Button -->
    ...
    <div class="max-w-2xl mx-auto">
        <div class="overflow-hidden bg-white border border-gray-100 shadow-sm rounded-xl">
            ...
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                ...
                <p class="mt-1 text-sm text-gray-600">Silakan isi nama jenis reimbursement di bawah ini</p>
            </div>
            ...
            <div class="p-6">
                ...
                <!-- Form -->
                <form action="{{ route('super-admin.reimbursement-types.store') }}" method="POST" class="space-y-6" id="typeForm">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="name" name="name" value="{{ old('name') }}"
                                ...
                                placeholder="Enter reimbursement type name (e.g., Transport, Meal, etc.)" required>
                    ...
                    <div class="flex items-center justify-end pt-6 space-x-4 border-t border-gray-200">
                        ...
                        <button type="submit" id="submitBtn"
                            ...
                            <span id="submitBtnText">Add Type</span>
