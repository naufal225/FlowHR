...
<main class="relative z-10 flex-1 p-0 space-y-6 overflow-x-hidden overflow-y-auto bg-gray-50">
    <div class="flex flex-col items-center sm:flex-row sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <div class="flex flex-col items-center gap-5 mt-4 sm:mt-0 sm:flex-row">
                <div class="mt-4 sm:mt-0">
                    <button onclick="window.location.href='{{ route('super-admin.reimbursements.create') }}'"
                        class="btn-primary">
    ...
    <div class="p-6 bg-white border rounded-xl shadow-soft border-neutral-200">
        <form id="filterForm" method="GET" action="{{ route('super-admin.reimbursements.index') }}"
            ...
            <div class="flex items-end">
                ...
                <a href="{{ route('super-admin.reimbursements.index') }}" class="btn-secondary">
                    ...
                    <tr class="transition-colors duration-200 hover:bg-neutral-50">
                        ...
                        <td class="px-6 py-4 text-md font-medium whitespace-nowrap">
                            <div class="flex items-center space-x-2">
                                <a href="{{ route('super-admin.reimbursements.show', $reimbursement->id) }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    exportButton.addEventListener('click', async function() {
        ...
        try {
            ...
            const exportUrl = `{{ route('super-admin.reimbursements.export') }}?${params.toString()}`;
