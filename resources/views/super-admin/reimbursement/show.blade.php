        ...
        <div class="space-y-6">
            ...
            <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
                ...
                <div class="p-6 space-y-3">
                    ...
                    <form id="delete-form-{{ $reimbursement->id }}" action="{{ route('super-admin.reimbursements.destroy', $reimbursement->id) }}"
                    ...
                    <button
                        onclick="window.location.href='{{ route('super-admin.reimbursements.exportPdf', $reimbursement->id) }}'"
