        ...
        <tbody class="divide-y divide-gray-50">
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-5 py-3">
                    ...
                    <p class="text-xs text-gray-500">
                        s/d {{ \Carbon\Carbon::parse($item->date_end)->format('d M Y, H:i') }}
                    </p>
                    @if($item->total)
                    <p class="text-xs text-primary-600 font-medium mt-0.5">{{ $item->total }} jam</p>
                    @endif
                </td>
                <td class="px-5 py-3">
                    @php
                ...
                <td class="px-5 py-3 text-right">
                    <a href="{{ route('overtimes.show', $item) }}"
            ...
            <tr>
                <td colspan="10" class="px-5 py-12 text-center">
                    ...
                    <p class="text-sm text-gray-400">Tidak ada data overtime.</p>
                </td>
            </tr>
            @endforelse
        </tbody>
