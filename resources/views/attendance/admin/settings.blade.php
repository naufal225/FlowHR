    ...
    @else
        <div class="grid grid-cols-1 gap-6 xl:grid-cols-[1.45fr_1fr]">
            <div class="p-6 bg-white border shadow-sm rounded-3xl border-slate-200">
                <form method="GET" action="{{ route($routePrefix . '.attendance.settings') }}" class="flex flex-col gap-3 pb-6 mb-6 border-b border-slate-100 sm:flex-row sm:items-end">
                    <div>
                ...
                @if($selectedOffice)
                    <form method="POST" action="{{ route($routePrefix . '.attendance.settings.update') }}" class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-slate-700" for="work_start_time">Work Start</label>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-slate-700" for="work_end_time">Work End</label>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-slate-700" for="late_tolerance_minutes">Late Tolerance Minutes</label>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-slate-700" for="qr_rotation_seconds">QR Rotation Seconds</label>
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-slate-700" for="min_location_accuracy_meter">Min Location Accuracy Meter</label>
