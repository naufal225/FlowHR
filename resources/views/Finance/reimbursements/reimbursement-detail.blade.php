                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            ...
                            <span
                                ...
                                {{ (Auth::id() === $reimbursement->employee_id && $reimbursement->status_1 === 'pending'
                                && !\App\Models\Division::where('leader_id', Auth::id())->exists()) ||
                                (\App\Models\Division::where('leader_id', Auth::id())->exists() &&
                                $reimbursement->status_2 === 'pending') ? 'Pending' : 'In Progress' }} Review
                            </span>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                ...
                                <span class="font-medium truncate text-neutral-900">{{ $reimbursement->approver->name ??
                                    'N/A' }}</span>
                            </div>
                        </div>
                        <!-- Total (was Amount) -->
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                ...
                                <span class="font-medium truncate text-neutral-900">{{ $reimbursement->customer ?? 'N/A'
                                    }}</span>
                            </div>
                        </div>
                        <!-- Type Reimbursement -->
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
                ...
                <div class="p-6 space-y-3">
                    ...
                    !\App\Models\Division::where('leader_id', Auth::id())->exists()) ||
                    (\App\Models\Division::where('leader_id', Auth::id())->exists() && $reimbursement->status_2 ===
                    'pending'))
                    <a href="{{ route('finance.reimbursements.edit', $reimbursement->id) }}"
                    ...
                    <form action="{{ route('finance.reimbursements.destroy', $reimbursement->id) }}" method="POST"
                    ...
                    <button
                        onclick="window.location.href='{{ route('finance.reimbursements.exportPdf', $reimbursement->id) }}'"
