...
<body>
    ...
    <div class="section">
        ...
        <table class="details-table">
            ...
            <tr>
                <td class="label-col">Overtime Bonus (Rp {{ number_format(env('OVERTIME_BONUS_COSTS', 30000), 0, ',', '.') }}):
                </td>
                <td class="data-col">
                    <div class="box">Rp {{ number_format(env('OVERTIME_BONUS_COSTS', 30000), 0, ',', '.') }}</div>
                </td>
            </tr>
            <tr>
