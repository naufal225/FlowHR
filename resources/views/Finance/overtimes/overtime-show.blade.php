...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0">
            <button onclick="window.location.href='{{ route('finance.overtimes.create') }}'"
    ...
    <p class="mb-2 text-sm text-neutral-500 ms-4">Your overtime requests are listed below.</p>
            ...
            <table class="min-w-full divide-y divide-neutral-200">
                ...
                <tbody class="bg-white divide-y divide-neutral-200">
                    ...
                    <tr class="transition-colors duration-200 hover:bg-neutral-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex items-center justify-center w-8 h-8 mr-3 rounded-full bg-success-100">
                                    ...
                                    <img class="object-cover rounded-full" src="{{ $overtime->employee->url_profile }}"
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-bold text-success-600">{{ '+Rp' . number_format($overtime->total ??
                                0, 0, ',', '.') }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
    ...
    <p class="mb-2 text-sm text-neutral-500 ms-4">All employee overtime (Marked done) requests are listed below.</p>
