<!-- Sidebar -->
<div class="fixed inset-y-0 left-0 z-50 flex flex-col w-64 text-white transition-transform duration-300 ease-in-out transform -translate-x-full sidebar-container bg-primary-800 shadow-medium lg:relative lg:translate-x-0"
    id="sidebar">
