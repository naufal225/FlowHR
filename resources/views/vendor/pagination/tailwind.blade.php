            ...
            <div>
                <span class="relative z-0 inline-flex rounded-md shadow-sm rtl:flex-row-reverse">
                    ...
                    @php
                        ...
                        // Pastikan minimal 5 halaman ditampilkan di sekitar current
                        ...
                        // Tambahkan halaman di sekitar current
                        for ($i = $start; $i <= $end; $i++) {
                            if ($i != 1 && $i != $lastPage) {
                                $pages[] = $i;
                            }
                        ...
                        // Tambahkan elipsis sebelum last page jika diperlukan
                        if ($end < $lastPage - 1) {
                            $pages[] = '...';
                        }

                        // Selalu tampilkan halaman terakhir (jika bukan 1)
                        if ($lastPage > 1) {
                            $pages[] = $lastPage;
                        }

                        // Hapus duplikat jika total halaman sedikit
                    ...
                    @foreach ($pages as $page)
                        @if ($page == '...')
                            <span aria-disabled="true">
                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-gray-700 bg-white border border-gray-300 cursor-default dark:bg-gray-800 dark:border-gray-600">...</span>
                            </span>
