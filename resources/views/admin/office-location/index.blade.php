...
<main class="relative z-10 flex-1 p-0 overflow-x-hidden overflow-y-auto bg-gray-50">
    ...
    <div class="mb-6">
        <div class="p-6 bg-white border border-gray-100 shadow-sm rounded-xl">
            <form class="flex flex-col gap-4 sm:flex-row" action="{{ route('admin.office-locations.index') }}" method="GET">
                <div class="flex-1">
                    <div class="relative">
                        ...
                        <tr class="transition-colors duration-200 hover:bg-neutral-50">
                            ...
                            <td class="px-6 py-4 text-md font-medium whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <a href="{{ route('admin.office-locations.show', $officeLocation) }}"
